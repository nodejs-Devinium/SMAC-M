...
class Lookup:
    ...
    def get_styleitems(self, chartsymbols, feature_name, geom_type, fields, layer_level):
        style = {
            'POINT': [],
            'LINE': [],
            'POLYGON': [],
        ...
        for command in self.instruction:
            styleitem = command(chartsymbols, feature_name, geom_type, fields, layer_level)
